...
# The name of a Pygments style to use for syntax highlighting:  tango, pastie,
# monokai, algol_nu, fruity, vim, paraiso-light, xcode, rrt, algol, trac, manni,
# igor, paraiso-dark, bw, borland, emacs, murphy, perldoc, colorful, native,
# autumn, vs, friendly, lovelace, default
c.TerminalInteractiveShell.highlighting_style = 'solarizedlight'
